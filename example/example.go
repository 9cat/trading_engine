...
func newOrder(c *gin.Context) {
	...
	var pt trading_engine.OrderType
	if param.PriceType == "market" {
		param.Price = "0"
		pt = trading_engine.OrderTypeMarket
		if param.Amount != "" {
			pt = trading_engine.OrderTypeMarketAmount
			...
			pt = trading_engine.OrderTypeMarketQuantity
		...
		pt = trading_engine.OrderTypeLimit
